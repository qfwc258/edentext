...
const de: Messages = {
  ...
  toolbarExpanded: {
    ...
    columnGapNeedsColumns: 'Nur in mehrspaltigem Text',
    ...
    bookmarkNeedsSelection: 'Markiere den Text, den die Textmarke umfassen soll',
    bookmarkNotInHf: 'Textmarken sind in Kopf-/Fußzeilen nicht verfügbar',
    insertCrossRef: 'Querverweis einfügen',
    newComment: 'Neuer Kommentar',
    crossRefNeedsBookmark: 'Erst eine Textmarke setzen — ein Querverweis zeigt darauf',
  ...
  bookmark: {
    dialogLabel: 'Textmarke',
    namePlaceholder: 'Name der Textmarke',
    existing: 'In diesem Dokument',
    none: 'Noch keine Textmarken',
    goTo: 'Zur Textmarke springen',
    crossRefLabel: 'Querverweis einfügen',
    formatText: 'Text der Textmarke',
    formatPage: 'Seitenzahl',
    openHint: (mod) => `${mod}+Klick, um zur Textmarke zu springen`,
  },
  crossRef: {
    title: 'Querverweis',
    type: 'Verweistyp',
    referTo: 'Verweisen auf',
    target: 'Ziel',
    includeDirection: '"Oben"/"unten" hinzufügen',
    separateWith: 'Zahlen trennen mit',
    none: 'Hier gibt es noch nichts, worauf verwiesen werden kann',
    above: 'oben',
    below: 'unten',
    kinds: {
      heading: 'Überschrift',
      numbered: 'Nummeriertes Element',
      bookmark: 'Textmarke',
      figure: 'Abbildung',
      table: 'Tabelle',
      footnote: 'Fußnote',
    ...
    formats: {
      ...
      headingText: 'Überschriftentext',
      headingNumber: 'Überschriftennummer',
      headingNumberNoContext: 'Überschriftennummer (ohne Kontext)',
      headingNumberFullContext: 'Überschriftennummer (voller Kontext)',
      paragraphText: 'Absatztext',
      paragraphNumber: 'Absatznummer',
      paragraphNumberNoContext: 'Absatznummer (ohne Kontext)',
      paragraphNumberFullContext: 'Absatznummer (voller Kontext)',
      bookmarkText: 'Text der Textmarke',
      wholeCaption: 'Gesamte Beschriftung',
      labelAndNumber: 'Nur Kategorie und Nummer',
      captionText: 'Nur Beschriftungstext',
      footnoteNumber: 'Fußnotennummer',
      endnoteNumber: 'Endnotennummer',
    },
  },
  link: {
  ...
  ribbon: {
    ...
    startsOnAny: 'Auf der nächsten Seite beginnen',
