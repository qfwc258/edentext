...
const en = {
  ...
  toolbarExpanded: {
    ...
    columnGapNeedsColumns: 'Only where the text is in columns',
  ...
  crossRef: {
    ...
    type: 'Reference type',
    referTo: 'Insert reference to',
    target: 'Target',
    includeDirection: 'Include above/below',
    separateWith: 'Separate numbers with',
    none: 'Nothing here to reference yet',
    above: 'above',
    below: 'below',
    kinds: {
      heading: 'Heading',
    ...
    formats: {
      ...
      headingNumberNoContext: 'Heading number (no context)',
      headingNumberFullContext: 'Heading number (full context)',
      paragraphText: 'Paragraph text',
      paragraphNumber: 'Paragraph number',
      paragraphNumberNoContext: 'Paragraph number (no context)',
      paragraphNumberFullContext: 'Paragraph number (full context)',
      bookmarkText: 'Bookmark text',
      wholeCaption: 'Entire caption',
      labelAndNumber: 'Only label and number',
      captionText: 'Only caption text',
      footnoteNumber: 'Footnote number',
      endnoteNumber: 'Endnote number',
    },
  },
  link: {
  ...
  ribbon: {
    ...
    startsOnAny: 'Start on the next page',
