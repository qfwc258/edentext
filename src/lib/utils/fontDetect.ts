...
export const CANDIDATE_FONTS: readonly string[] = [
  ...
  'DengXian', 'DengXian Light', 'DFKai-SB', 'FangSong',
  'Franklin Gothic Medium', 'Gabriola', 'Gadugi', 'Javanese Text',
  'KaiTi', 'Leelawadee UI', 'Lucida Sans', 'Malgun Gothic', 'Marlett',
  ...
  'Microsoft Yi Baiti', 'MingLiU', 'MingLiU-ExtB', 'Mongolian Baiti',
  'MS Gothic', 'MS Mincho', 'MS PGothic', 'MV Boli',
  'Myanmar Text', 'Nirmala UI', 'NSimSun', 'Palatino Linotype', 'PMingLiU',
  ...
  'SimHei', 'SimSun', 'Sitka', 'Sylfaen', 'Symbol', 'Webdings', 'Wingdings',
  ...
  'GungSeo', 'HeadLineA', 'Heiti SC', 'Heiti TC', 'Herculanum',
  'Hiragino Maru Gothic Pro',
  'Hiragino Mincho ProN', 'Hiragino Sans', 'Hiragino Sans GB',
  'Hoefler Text', 'Iowan Old Style', 'Kaiti SC', 'Kaiti TC', 'Kefa',
  ...
  'Snell Roundhand', 'Songti SC', 'Songti TC', 'STIX Two Math', 'STSong',
  'Superclarendon', 'Tamil Sangam MN',
  ...
  'Noto Serif CJK TC', 'Source Han Sans SC', 'WenQuanYi Micro Hei',
